package com.mutabeni.store.security.config;
...
import static com.mutabeni.store.security.user.Permission.*;
import static com.mutabeni.store.security.user.Permission.APPLICANT_DELETE;
import static com.mutabeni.store.security.user.Role.ADMIN;
import static com.mutabeni.store.security.user.Role.APPLICANT;
...
public class SecurityConfiguration {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http.cors().and()
        ...
        .requestMatchers(PUT, "/applicant/**").hasAuthority(APPLICANT_UPDATE.name())
        .requestMatchers(DELETE, "/applicant/**").hasAuthority(APPLICANT_DELETE.name())
        ...
        .requestMatchers(GET, "/profile/**").hasAnyAuthority(ADMIN_READ.name(), APPLICANT_READ.name())
         ...
         .requestMatchers("/product/**").hasAnyRole(ADMIN.name(), APPLICANT.name())
         .requestMatchers(GET, "/product/**").hasAnyAuthority(ADMIN_READ.name(), APPLICANT_READ.name())
