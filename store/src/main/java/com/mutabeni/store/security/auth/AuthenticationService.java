...
import com.mutabeni.store.security.config.JwtService;
import com.mutabeni.store.security.token.Token;
import com.mutabeni.store.security.token.TokenRepository;
import com.mutabeni.store.security.token.TokenType;
...
User user = new User(request.getName(),  request.getContact(), request.getCity(), request.getEmail(), passwordEncoder.encode(request.getPassword()), request.getRole());
